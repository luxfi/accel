...
func (o *stubMLOps) LayerNorm(input, gamma, beta, output *UntypedTensor, eps float32) error    { return ErrNoBackends }
func (o *stubMLOps) Attention(q, k, v, output *UntypedTensor, scale float32) error             { return ErrNoBackends }
func (o *stubMLOps) Conv2D(input, kernel, output *UntypedTensor, stride, padding [2]int) error { return ErrNoBackends }
func (o *stubMLOps) MaxPool2D(input, output *UntypedTensor, kernelSize, stride [2]int) error   { return ErrNoBackends }
...
func (o *stubCryptoOps) BLSAggregate(signatures, aggregated *UntypedTensor) error { return ErrNoBackends }
...
func (o *stubZKOps) NTT(input, output, roots *UntypedTensor, modulus uint64) error     { return ErrNoBackends }
func (o *stubZKOps) INTT(input, output, invRoots *UntypedTensor, modulus uint64) error { return ErrNoBackends }
...
func (o *stubLatticeOps) DilithiumSignBatch(msgs, sk, sigs *UntypedTensor) error { return ErrNoBackends }
...
func (o *stubLatticeOps) PolynomialNTT(input, output *UntypedTensor, q uint32) error  { return ErrNoBackends }
func (o *stubLatticeOps) PolynomialINTT(input, output *UntypedTensor, q uint32) error { return ErrNoBackends }
...
func (o *stubFHEOps) BFVEncryptBatch(plaintexts, pk, ciphertexts *UntypedTensor) error { return ErrNoBackends }
...
func (o *stubFHEOps) BFVMultiply(ct1, ct2, relinKey, result *UntypedTensor) error     { return ErrNoBackends }
...
func (o *stubFHEOps) CKKSDecrypt(ciphertext, sk, plaintext *UntypedTensor) error  { return ErrNoBackends }
func (o *stubFHEOps) CKKSAdd(ct1, ct2, result *UntypedTensor) error               { return ErrNoBackends }
func (o *stubFHEOps) CKKSMultiply(ct1, ct2, relinKey, result *UntypedTensor) error { return ErrNoBackends }
...
func (o *stubDEXOps) MatchOrdersWithPriority(bids, asks, matches *UntypedTensor) error { return ErrNoBackends }
